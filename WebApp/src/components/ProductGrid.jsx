...
export default function ProductGrid() {
  ...
  if (!products.length) return <div className="text-center py-6 text-gray-500">No products found</div>;

  return (
    <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4">
      {products.map((product) => {
        const firstImage = product.images?.[0]?.image || product.images?.[0]?.url || "/placeholder.svg";
