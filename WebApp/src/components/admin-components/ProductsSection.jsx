    ...
    try {
      for (const item of receiptData.items) {
        const productData = {
          ...
          brand: item.brandId ? parseInt(item.brandId, 10) : null,
          category: item.categoryId ? parseInt(item.categoryId, 10) : null,
          condition: item.conditionId ? parseInt(item.conditionId, 10) : null,
