...
\restrict 4If1seXWWdJnKr5ze6FHxTLBXUfgQFtsM4Cu9WRreSEgUiHzEnKDKeUCBGT5S6T
...
--
-- Name: calc_sales_sub_total(); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.calc_sales_sub_total() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
  NEW.sub_total := NEW.quantity * NEW.selling_price;
  RETURN NEW;
END;
$$;


ALTER FUNCTION public.calc_sales_sub_total() OWNER TO postgres;

--
-- Name: update_sales_total_amount(); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.update_sales_total_amount() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
  UPDATE sale
...
ALTER FUNCTION public.update_sales_total_amount() OWNER TO postgres;

--
-- Name: update_sub_total(); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.update_sub_total() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
...
ALTER FUNCTION public.update_sub_total() OWNER TO postgres;
...
BEGIN
  ...
  SET total_cost = (
    ...
    FROM supply_details
    WHERE supply_details.supply_id = NEW.supply_id
  )
...
CREATE TABLE public.courier (
    ...
    name character varying(255) NOT NULL,
    base_rate numeric(10,2) DEFAULT 50.00,
    rate_per_kg numeric(10,2) DEFAULT 30.00,
...
--
-- Name: product_car_compatibility_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.product_car_compatibility_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.product_car_compatibility_id_seq OWNER TO postgres;

--
-- Name: product_car_compatibility_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.product_car_compatibility_id_seq OWNED BY public.product_car_compatibility.id;
...
CREATE SEQUENCE public.user_cart_cart_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.user_cart_cart_id_seq OWNER TO postgres;

--
-- Name: user_cart_cart_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.user_cart_cart_id_seq OWNED BY public.user_cart.cart_id;
...
--
-- Name: product_car_compatibility id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.product_car_compatibility ALTER COLUMN id SET DEFAULT nextval('public.product_car_compatibility_id_seq'::regclass);
...
--
-- Name: user_cart cart_id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.user_cart ALTER COLUMN cart_id SET DEFAULT nextval('public.user_cart_cart_id_seq'::regclass);
...
1	La Verna Hills Buhangin Davao City	68	1	t
2	Narra Street Craftshop	40	1	f
\.
...
81	Can add car	21	add_car
82	Can change car	21	change_car
83	Can delete car	21	delete_car
84	Can view car	21	view_car
85	Can add car model	22	add_carmodel
86	Can change car model	22	change_carmodel
87	Can delete car model	22	delete_carmodel
88	Can view car model	22	view_carmodel
89	Can add product car compatibility	23	add_productcarcompatibility
90	Can change product car compatibility	23	change_productcarcompatibility
91	Can delete product car compatibility	23	delete_productcarcompatibility
92	Can view product car compatibility	23	view_productcarcompatibility
...
97	Can add product year	25	add_productyear
98	Can change product year	25	change_productyear
99	Can delete product year	25	delete_productyear
100	Can view product year	25	view_productyear
...
105	Can add barangay	27	add_barangay
106	Can change barangay	27	change_barangay
107	Can delete barangay	27	delete_barangay
108	Can view barangay	27	view_barangay
109	Can add courier	28	add_courier
110	Can change courier	28	change_courier
111	Can delete courier	28	delete_courier
112	Can view courier	28	view_courier
113	Can add delivery	29	add_delivery
114	Can change delivery	29	change_delivery
115	Can delete delivery	29	delete_delivery
116	Can view delivery	29	view_delivery
117	Can add delivery status	30	add_deliverystatus
118	Can change delivery status	30	change_deliverystatus
119	Can delete delivery status	30	delete_deliverystatus
120	Can view delivery status	30	view_deliverystatus
121	Can add mode payment	31	add_modepayment
122	Can change mode payment	31	change_modepayment
123	Can delete mode payment	31	delete_modepayment
124	Can view mode payment	31	view_modepayment
125	Can add municipality	32	add_municipality
126	Can change municipality	32	change_municipality
127	Can delete municipality	32	delete_municipality
128	Can view municipality	32	view_municipality
129	Can add province	33	add_province
130	Can change province	33	change_province
131	Can delete province	33	delete_province
132	Can view province	33	view_province
133	Can add region	34	add_region
134	Can change region	34	change_region
135	Can delete region	34	delete_region
136	Can view region	34	view_region
137	Can add user cart	35	add_usercart
138	Can change user cart	35	change_usercart
139	Can delete user cart	35	delete_usercart
140	Can view user cart	35	view_usercart
\.
...
COPY public.courier (courier_id, name, base_rate, rate_per_kg, max_weight, delivery_time) FROM stdin;
1	J&T Express	50.00	30.00	\N	\N
2	Ninja Van	50.00	30.00	\N	\N
\.
...
11	9	1	1	200	7100	2025-10-10	4	T#0000000009
12	10	1	1	65	1665	2025-10-10	1	T#0000000010
9	7	1	1	200	7100	2025-10-10	6	T#0000000007
5	1	1	1	100	900	2025-10-03	6	T#0000312314
\.
...
1	Pending	Order received but not yet processed	1
2	Packed	Items are packed and ready for dispatch	2
3	Shipped	Package has left the warehouse	3
4	In Transit	Carrier is currently transporting the item	4
5	Out for Delivery	Courier is on the way to the customer	5
6	Delivered	Customer has received the order	6
7	Cancelled	Order was cancelled before delivery	0
8	Returned	Item was returned by the customer	7
\.
...
21	core	car
22	core	carmodel
23	core	productcarcompatibility
24	core	productimage
25	core	productyear
26	core	address
27	core	barangay
28	core	courier
29	core	delivery
30	core	deliverystatus
31	core	modepayment
32	core	municipality
33	core	province
34	core	region
35	core	usercart
\.
...
35	core	0002_car_carmodel_productcarcompatibility_productimage_and_more	2025-10-05 12:26:04.32126+08
36	core	0003_address_barangay_courier_delivery_deliverystatus_and_more	2025-10-07 21:16:47.58089+08
37	core	0004_alter_courier_options	2025-10-09 22:49:27.303582+08
\.
...
21	default	t	1	842094	2025-10-03 17:21:25.382652+08	jamespcarba@gmail.com	0	\N	\N	2025-10-03 17:11:25.382691+08	\N
22	default	t	1	323822	2025-10-03 21:38:24.059835+08	jamespcarba@gmail.com	0	\N	\N	2025-10-03 21:28:24.059878+08	\N
23	default	t	1	707786	2025-10-04 10:10:14.204287+08	jamespcarba@gmail.com	0	\N	\N	2025-10-04 10:00:14.204327+08	\N
24	default	t	1	122291	2025-10-04 12:03:29.429299+08	jamespcarba@gmail.com	0	\N	\N	2025-10-04 11:53:29.429348+08	\N
25	default	t	1	094608	2025-10-04 12:27:56.858227+08	jamespcarba@gmail.com	0	\N	\N	2025-10-04 12:17:56.858259+08	\N
26	default	t	1	115754	2025-10-04 13:51:04.227977+08	jamespcarba@gmail.com	0	\N	\N	2025-10-04 13:41:04.228279+08	\N
27	default	t	1	341992	2025-10-04 13:59:05.841728+08	jamespcarba@gmail.com	0	\N	\N	2025-10-04 13:49:05.841797+08	\N
28	default	t	1	437987	2025-10-04 14:02:08.131351+08	jamespcarba@gmail.com	0	\N	\N	2025-10-04 13:52:08.131419+08	\N
29	default	t	16	467643	2025-10-04 14:04:10.577541+08	akosiNatoy@gmail.com	0	\N	\N	2025-10-04 13:54:10.577587+08	\N
30	default	t	1	395352	2025-10-04 14:04:42.34762+08	jamespcarba@gmail.com	0	\N	\N	2025-10-04 13:54:42.347667+08	\N
31	default	t	1	472431	2025-10-04 14:14:46.902423+08	jamespcarba@gmail.com	0	\N	\N	2025-10-04 14:04:46.902473+08	\N
32	default	t	1	949266	2025-10-04 14:17:31.118246+08	jamespcarba@gmail.com	0	\N	\N	2025-10-04 14:07:31.118307+08	\N
33	default	t	1	847698	2025-10-04 14:10:29.434244+08	jamespcarba@gmail.com	0	\N	\N	2025-10-04 14:10:22.979914+08	\N
34	default	t	1	312802	2025-10-04 14:13:15.20284+08	jamespcarba@gmail.com	0	\N	\N	2025-10-04 14:13:04.187298+08	\N
35	default	t	1	346581	2025-10-04 14:14:39.524328+08	jamespcarba@gmail.com	0	\N	\N	2025-10-04 14:14:22.326541+08	\N
36	default	t	1	971066	2025-10-04 14:15:56.497217+08	jamespcarba@gmail.com	0	\N	\N	2025-10-04 14:15:48.528319+08	\N
37	default	t	1	497321	2025-10-04 14:18:35.782431+08	jamespcarba@gmail.com	0	\N	\N	2025-10-04 14:18:28.408872+08	\N
38	default	t	1	404269	2025-10-04 14:23:12.264337+08	jamespcarba@gmail.com	0	\N	\N	2025-10-04 14:22:57.288901+08	\N
39	default	t	1	275901	2025-10-04 14:25:52.604311+08	jamespcarba@gmail.com	0	\N	\N	2025-10-04 14:25:47.112081+08	\N
40	default	t	16	640297	2025-10-04 14:28:11.504915+08	akosiNatoy@gmail.com	0	\N	\N	2025-10-04 14:27:58.837198+08	\N
41	default	t	1	919155	2025-10-04 14:31:32.176867+08	jamespcarba@gmail.com	0	\N	\N	2025-10-04 14:31:24.073794+08	\N
42	default	t	1	892963	2025-10-04 14:34:45.781279+08	jamespcarba@gmail.com	0	\N	\N	2025-10-04 14:34:33.461132+08	\N
43	default	t	1	296037	2025-10-04 14:40:37.889403+08	jamespcarba@gmail.com	0	\N	\N	2025-10-04 14:40:31.644528+08	\N
44	default	t	1	916582	2025-10-04 14:41:50.144021+08	jamespcarba@gmail.com	0	\N	\N	2025-10-04 14:41:38.364856+08	\N
45	default	t	1	387679	2025-10-04 14:42:49.272255+08	jamespcarba@gmail.com	0	\N	\N	2025-10-04 14:42:42.352533+08	\N
46	default	t	1	000773	2025-10-04 14:46:21.330958+08	jamespcarba@gmail.com	0	\N	\N	2025-10-04 14:46:13.069068+08	\N
47	default	t	1	392242	2025-10-04 20:18:55.158602+08	jamespcarba@gmail.com	0	\N	\N	2025-10-04 20:18:47.363252+08	\N
48	default	t	1	963653	2025-10-04 20:20:03.028012+08	jamespcarba@gmail.com	0	\N	\N	2025-10-04 20:19:55.735979+08	\N
49	default	t	1	025701	2025-10-04 20:23:38.205218+08	jamespcarba@gmail.com	0	\N	\N	2025-10-04 20:23:28.62969+08	\N
50	default	t	1	991793	2025-10-04 21:27:03.923982+08	jamespcarba@gmail.com	0	\N	\N	2025-10-04 21:26:58.185367+08	\N
51	default	t	1	023667	2025-10-04 21:33:14.864275+08	jamespcarba@gmail.com	0	\N	\N	2025-10-04 21:33:07.63448+08	\N
52	default	t	1	421701	2025-10-04 21:50:56.148405+08	jamespcarba@gmail.com	0	\N	\N	2025-10-04 21:50:51.053843+08	\N
53	default	t	1	912353	2025-10-04 22:05:20.45853+08	jamespcarba@gmail.com	0	\N	\N	2025-10-04 22:05:07.286764+08	\N
54	default	t	1	302196	2025-10-04 22:20:38.114393+08	jamespcarba@gmail.com	0	\N	\N	2025-10-04 22:20:32.959788+08	\N
55	default	t	1	959347	2025-10-04 22:45:04.466963+08	jamespcarba@gmail.com	0	\N	\N	2025-10-04 22:44:58.11824+08	\N
56	default	t	1	206989	2025-10-05 00:23:08.92064+08	jamespcarba@gmail.com	0	\N	\N	2025-10-05 00:22:56.767834+08	\N
57	default	t	1	058457	2025-10-05 12:02:14.125549+08	jamespcarba@gmail.com	0	\N	\N	2025-10-05 12:02:06.282252+08	\N
58	default	f	1	801586	2025-10-05 13:22:57.781908+08	jamespcarba@gmail.com	0	\N	\N	2025-10-05 13:12:57.781949+08	\N
59	default	f	1	842128	2025-10-05 13:23:00.248307+08	jamespcarba@gmail.com	0	\N	\N	2025-10-05 13:13:00.248373+08	\N
60	default	f	1	670167	2025-10-05 13:23:10.512425+08	jamespcarba@gmail.com	0	\N	\N	2025-10-05 13:13:10.512454+08	\N
61	default	f	1	708229	2025-10-05 13:23:15.700528+08	jamespcarba@gmail.com	0	\N	\N	2025-10-05 13:13:15.700559+08	\N
62	default	f	1	765009	2025-10-05 13:23:16.148219+08	jamespcarba@gmail.com	0	\N	\N	2025-10-05 13:13:16.148248+08	\N
63	default	f	1	715808	2025-10-05 13:23:16.355067+08	jamespcarba@gmail.com	0	\N	\N	2025-10-05 13:13:16.355093+08	\N
64	default	f	1	645902	2025-10-05 13:23:34.363621+08	jamespcarba@gmail.com	0	\N	\N	2025-10-05 13:13:34.363651+08	\N
65	default	f	1	192853	2025-10-05 13:25:08.354367+08	jamespcarba@gmail.com	0	\N	\N	2025-10-05 13:15:08.354398+08	\N
66	default	f	1	628475	2025-10-05 13:25:09.205092+08	jamespcarba@gmail.com	0	\N	\N	2025-10-05 13:15:09.205122+08	\N
67	default	f	1	050928	2025-10-05 13:25:09.369998+08	jamespcarba@gmail.com	0	\N	\N	2025-10-05 13:15:09.370026+08	\N
68	default	f	1	374726	2025-10-05 13:25:09.490237+08	jamespcarba@gmail.com	0	\N	\N	2025-10-05 13:15:09.490257+08	\N
69	default	t	1	861843	2025-10-05 13:17:05.735451+08	jamespcarba@gmail.com	0	\N	\N	2025-10-05 13:16:59.146718+08	\N
70	default	t	1	707749	2025-10-05 13:38:57.465953+08	jamespcarba@gmail.com	0	\N	\N	2025-10-05 13:38:49.384288+08	\N
71	default	t	1	322240	2025-10-05 14:56:14.197854+08	jamespcarba@gmail.com	0	\N	\N	2025-10-05 14:56:09.386883+08	\N
72	default	t	1	670004	2025-10-05 16:31:38.49236+08	jamespcarba@gmail.com	0	\N	\N	2025-10-05 16:31:32.656845+08	\N
73	default	t	1	393755	2025-10-05 17:49:23.649221+08	jamespcarba@gmail.com	0	\N	\N	2025-10-05 17:49:16.818339+08	\N
74	default	t	1	589462	2025-10-05 19:49:36.610301+08	jamespcarba@gmail.com	0	\N	\N	2025-10-05 19:49:25.008523+08	\N
75	default	t	1	222505	2025-10-06 13:42:53.540464+08	jamespcarba@gmail.com	0	\N	\N	2025-10-06 13:42:42.136503+08	\N
76	default	t	1	558584	2025-10-06 21:27:03.217357+08	jamespcarba@gmail.com	0	\N	\N	2025-10-06 21:26:50.12105+08	\N
77	default	t	1	037686	2025-10-06 22:45:07.963416+08	jamespcarba@gmail.com	0	\N	\N	2025-10-06 22:45:01.173267+08	\N
78	default	t	1	897193	2025-10-07 20:43:56.917454+08	jamespcarba@gmail.com	0	\N	\N	2025-10-07 20:43:51.144457+08	\N
79	default	t	1	475263	2025-10-07 21:44:47.820211+08	jamespcarba@gmail.com	0	\N	\N	2025-10-07 21:44:38.700335+08	\N
80	default	t	1	274005	2025-10-07 22:47:52.480294+08	jamespcarba@gmail.com	0	\N	\N	2025-10-07 22:47:45.962274+08	\N
81	default	t	1	053904	2025-10-07 22:55:19.415355+08	jamespcarba@gmail.com	0	\N	\N	2025-10-07 22:55:11.194661+08	\N
82	default	t	1	994486	2025-10-07 22:58:21.138053+08	jamespcarba@gmail.com	0	\N	\N	2025-10-07 22:58:09.526411+08	\N
83	default	t	1	100933	2025-10-07 23:00:17.86095+08	jamespcarba@gmail.com	0	\N	\N	2025-10-07 23:00:11.404431+08	\N
84	default	f	1	435718	2025-10-07 23:11:52.506135+08	jamespcarba@gmail.com	0	\N	\N	2025-10-07 23:01:52.506168+08	\N
85	default	f	1	857488	2025-10-07 23:12:05.023256+08	jamespcarba@gmail.com	0	\N	\N	2025-10-07 23:02:05.023282+08	\N
86	default	t	1	449003	2025-10-07 23:04:21.604472+08	jamespcarba@gmail.com	0	\N	\N	2025-10-07 23:04:17.194098+08	\N
87	default	t	16	778434	2025-10-08 00:08:02.509341+08	akosiNatoy@gmail.com	0	\N	\N	2025-10-08 00:07:55.822217+08	\N
88	default	t	1	810258	2025-10-08 20:45:46.637096+08	jamespcarba@gmail.com	0	\N	\N	2025-10-08 20:45:38.561953+08	\N
89	default	t	1	418603	2025-10-08 22:30:55.921516+08	jamespcarba@gmail.com	0	\N	\N	2025-10-08 22:30:46.316067+08	\N
90	default	t	1	503681	2025-10-09 11:21:51.7459+08	jamespcarba@gmail.com	0	\N	\N	2025-10-09 11:21:41.374532+08	\N
91	default	t	1	695600	2025-10-09 19:17:55.499429+08	jamespcarba@gmail.com	0	\N	\N	2025-10-09 19:17:26.060118+08	\N
92	default	t	1	700660	2025-10-09 19:42:06.951646+08	jamespcarba@gmail.com	0	\N	\N	2025-10-09 19:42:00.242381+08	\N
93	default	t	1	897814	2025-10-09 21:56:15.36008+08	jamespcarba@gmail.com	0	\N	\N	2025-10-09 21:56:11.488192+08	\N
94	default	t	1	793011	2025-10-09 23:17:45.101929+08	jamespcarba@gmail.com	0	\N	\N	2025-10-09 23:17:39.363795+08	\N
95	default	t	1	986252	2025-10-10 10:53:12.43432+08	jamespcarba@gmail.com	0	\N	\N	2025-10-10 10:53:00.126115+08	\N
96	default	t	1	518815	2025-10-10 12:14:56.53799+08	jamespcarba@gmail.com	0	\N	\N	2025-10-10 12:14:49.0998+08	\N
97	default	t	1	803058	2025-10-10 13:16:35.144007+08	jamespcarba@gmail.com	0	\N	\N	2025-10-10 13:16:30.045864+08	\N
98	default	t	1	669386	2025-10-10 14:17:27.586567+08	jamespcarba@gmail.com	0	\N	\N	2025-10-10 14:17:20.579847+08	\N
99	default	t	1	317409	2025-10-10 19:00:07.256511+08	jamespcarba@gmail.com	0	\N	\N	2025-10-10 18:59:57.376374+08	\N
100	default	t	1	411635	2025-10-10 20:31:31.876155+08	jamespcarba@gmail.com	0	\N	\N	2025-10-10 20:31:27.038505+08	\N
\.
...
COPY public.product (product_id, name, description, brand_id, category_id, purchase_price, selling_price, quantity, weight) FROM stdin;
3	NGK - Iridium		8	5	1200	1700	5	0.5
6	Super Diesel Oil		5	6	800	1200	5	0.5
7	Delo Gold 15W-40		5	6	800	1200	5	0.5
8	Havoline Full Synthetic Multi Vehicle		5	6	700	1100	5	0.5
2	NGK- GPower Platinum	SECOND BEST SPARKPLUG	8	5	1700	2100	5	0.5
10	DB 1252 GCT		6	7	2200	2600	7	0.5
12	B14 - 078773		4	7	3000	3500	9	0.5
1	Bosch Platinum	Updated desc	7	5	1500	1900	5	0.5
13	A-1517		9	8	500	1000	10	0.5
15	Air Filter Fujiyama		10	8	200	500	5	0.5
16	Sakura F-1007		9	9	200	600	7	0.5
14	A - 58370		9	8	200	500	5	0.5
4	NGK - Platinum	BEST NGK Spark Plug	8	5	1700	2100	5	0.5
5	Havoline-SF Engine Oil		5	6	600	1000	5	0.5
11	DB 1943 GCT		6	7	2300	2700	5	3
9	Texamatic 1888		5	6	1300	1600	19	0.5
\.
...
COPY public.product_car_compatibility (product_id, model_id, start_year_id, end_year_id, id) FROM stdin;
1	1	30	32	1
1	2	28	30	2
3	10	15	17	4
12	3	31	36	5
...
1	2	products/DSCF1110.JPG
2	2	products/DSCF1111.JPG
3	2	products/DSCF1113.JPG
4	2	products/DSCF1114.JPG
5	2	products/DSCF1115.JPG
6	1	products/DSCF1116.JPG
7	1	products/DSCF1117.JPG
8	1	products/DSCF1118.JPG
9	3	products/DSCF1103.JPG
10	3	products/DSCF1104.JPG
11	3	products/DSCF1105.JPG
12	3	products/DSCF1107.JPG
13	3	products/DSCF1108.JPG
14	4	products/DSCF1098.JPG
15	4	products/DSCF1099.JPG
16	4	products/DSCF1100.JPG
17	4	products/DSCF1101.JPG
18	4	products/DSCF1102.JPG
19	8	products/DSCF1094.png
20	8	products/DSCF1095.png
21	7	products/DSCF1092.png
22	7	products/DSCF1093.png
23	6	products/DSCF1088.png
24	6	products/DSCF1089.png
25	5	products/DSCF1090.png
26	5	products/DSCF1091.png
27	9	products/DSCF1096.JPG
28	9	products/DSCF1097.JPG
29	12	products/DSCF1081.png
30	12	products/DSCF1082.png
31	12	products/DSCF1084.png
32	12	products/DSCF1086.png
33	12	products/DSCF1087.png
34	11	products/DSCF1075.png
35	11	products/DSCF1076.png
36	11	products/DSCF1078.png
37	11	products/DSCF1079.png
38	11	products/DSCF1080.png
39	10	products/DSCF1070.png
40	10	products/DSCF1071.png
41	10	products/DSCF1072.png
42	10	products/DSCF1073.png
43	10	products/DSCF1074.png
44	16	products/DSCF1021.JPG
45	16	products/DSCF1022.JPG
46	16	products/DSCF1023.JPG
47	16	products/DSCF1024.JPG
48	16	products/DSCF1028.JPG
49	15	products/DSCF1042.png
50	15	products/DSCF1043.png
51	15	products/DSCF1048.png
52	14	products/DSCF1044.png
53	14	products/DSCF1045.png
54	14	products/DSCF1046.png
55	13	products/DSCF1037.png
56	13	products/DSCF1038.png
57	13	products/DSCF1040.png
\.
...
COPY public.sale (sale_id, user_id, total_amount, payment_type, date) FROM stdin;
1	1	800	Cash on Delivery	2025-10-03
7	1	6900	cod	2025-10-10
9	1	6900	cod	2025-10-10
10	1	1600	cod	2025-10-10
\.
...
1	Toyota	09432231523	Davao City Airport
3	BYD	09432355523	Davao City Lanang
4	Toyota Manila	09433235523	Manila City
2	Ford Town	09433245523	Davao City Quirino San Pedro
5	Caltex 	09328931231	Davao City Landmark Caltex
7	Throtl Cebu City		
8	Ford Cebu		
9	Toyota Cagayan		
10	Auto Supply China		
\.
...
1	1	10	16000.00	RCP-204725	2025-10-04
2	1	9	14500.00	RCP-145061	2025-10-04
3	1	5	14500.00	RCP-224350	2025-10-06
4	1	5	26000.00	RCP-536705	2025-10-06
5	1	7	60800.00	RCP-908938	2025-10-06
6	1	10	2500.00	RCP-525051	2025-10-06
7	1	10	1000.00	RCP-794804	2025-10-06
8	1	10	1000.00	RCP-730930	2025-10-06
9	1	10	1000.00	RCP-961036	2025-10-06
\.
...
1	1	1	5	1500	7500.00	1
2	1	2	5	1700	8500.00	1
3	2	3	5	1200	6000.00	1
4	2	4	5	1700	8500.00	1
5	3	5	5	600	3000.00	1
6	3	6	5	800	4000.00	1
7	3	7	5	800	4000.00	1
8	3	8	5	700	3500.00	1
9	4	9	20	1300	26000.00	1
10	5	10	7	2200	15400.00	1
11	5	11	8	2300	18400.00	1
12	5	12	9	3000	27000.00	1
13	6	13	5	500	2500.00	1
14	7	14	5	200	1000.00	1
15	8	15	5	200	1000.00	1
16	9	16	5	200	1000.00	1
\.
...
COPY public.user_cart (user_id, product_id, quantity, price_at_addition, created_at, updated_at, cart_id) FROM stdin;
16	16	1	600.00	2025-10-08 00:08:14.516783+08	2025-10-08 00:08:14.516804+08	9
\.
...
SELECT pg_catalog.setval('public.brand_brand_id_seq', 10, true);
...
SELECT pg_catalog.setval('public.car_models_model_id_seq', 19, true);
...
SELECT pg_catalog.setval('public.condition_item_condition_id_seq', 4, true);
...
SELECT pg_catalog.setval('public.courier_courier_id_seq', 2, true);
...
SELECT pg_catalog.setval('public.delivery_delivery_id_seq', 12, true);
...
SELECT pg_catalog.setval('public.otp_email_emaildevice_id_seq', 100, true);


--
-- Name: product_car_compatibility_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.product_car_compatibility_id_seq', 6, true);
...
SELECT pg_catalog.setval('public.product_image_id_seq', 57, true);
...
SELECT pg_catalog.setval('public.product_years_year_id_seq', 36, true);
...
SELECT pg_catalog.setval('public.sale_details_sale_detail_id_seq', 31, true);
...
SELECT pg_catalog.setval('public.sale_sale_id_seq', 10, true);
...
SELECT pg_catalog.setval('public.supply_details_id_seq', 16, true);
...
SELECT pg_catalog.setval('public.supply_supply_id_seq', 9, true);
...
SELECT pg_catalog.setval('public.user_cart_cart_id_seq', 11, true);
...
ALTER TABLE ONLY public.product_car_compatibility
    ADD CONSTRAINT product_car_compatibility_pkey PRIMARY KEY (id);
...
ALTER TABLE ONLY public.user_cart
    ADD CONSTRAINT user_cart_pkey PRIMARY KEY (cart_id);


--
-- Name: user_cart user_cart_user_product_unique; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.user_cart
    ADD CONSTRAINT user_cart_user_product_unique UNIQUE (user_id, product_id);
...
--
-- Name: supply_details auto_set_sub_total; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER auto_set_sub_total BEFORE INSERT OR UPDATE ON public.supply_details FOR EACH ROW EXECUTE FUNCTION public.update_sub_total();


--
-- Name: supply_details recalculate_total_cost; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER recalculate_total_cost AFTER INSERT OR UPDATE ON public.supply_details FOR EACH ROW EXECUTE FUNCTION public.update_total_cost();


--
-- Name: sale_details trigger_calc_sub_total; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER trigger_calc_sub_total BEFORE INSERT OR UPDATE ON public.sale_details FOR EACH ROW EXECUTE FUNCTION public.calc_sales_sub_total();


--
-- Name: sale_details trigger_update_total_amount; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER trigger_update_total_amount AFTER INSERT OR DELETE OR UPDATE ON public.sale_details FOR EACH ROW EXECUTE FUNCTION public.update_sales_total_amount();
...
--
-- Name: product_image fk_product; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
\unrestrict 4If1seXWWdJnKr5ze6FHxTLBXUfgQFtsM4Cu9WRreSEgUiHzEnKDKeUCBGT5S6T
